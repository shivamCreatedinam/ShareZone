import { AudioAinsMode, AudioEffectPreset, AudioEncodedFrameObserverConfig, AudioProfileType, AudioRecordingConfiguration, AudioScenarioType, AudioSessionOperationRestriction, BeautyOptions, ChannelMediaRelayConfiguration, ChannelProfileType, ClientRoleOptions, ClientRoleType, CodecCapInfo, ColorEnhanceOptions, ConnectionStateType, DataStreamConfig, DeviceInfo, EarMonitoringFilterType, EchoTestConfiguration, EncryptionConfig, HeadphoneEqualizerPreset, IAudioEncodedFrameObserver, LastmileProbeConfig, LiveTranscoding, LocalAccessPointConfiguration, LocalTranscoderConfiguration, LowlightEnhanceOptions, RecorderStreamInfo, Rectangle, ScreenCaptureParameters, ScreenCaptureParameters2, ScreenScenarioType, SegmentationProperty, SenderOptions, SimulcastStreamConfig, SimulcastStreamMode, SpatialAudioParams, UserInfo, VideoApplicationScenarioType, VideoCanvas, VideoContentHint, VideoDenoiserOptions, VideoEncoderConfiguration, VideoFormat, VideoMirrorModeType, VideoOrientation, VideoQoePreferenceType, VideoStreamType, VideoSubscriptionOptions, VirtualBackgroundSource, VoiceBeautifierPreset, VoiceConversionPreset, WatermarkOptions } from '../AgoraBase';
